...
{
   [TestClass]
   public partial class ETrade10Test : ETrade10TestBase
   {
      [TestInitialize]
      ...
      {
         //Assert.IsTrue(Rest20.Credentials.GetDefaultCredentials().Environment == m_Environment, "Credentials Environment is incorrect.");
         //Assert.IsTrue(Rest20.Credentials.GetDefaultCredentials().AccessToken == m_ConsumerKey, "Credentials Token is incorrect.");
         //Assert.IsTrue(Rest20.Credentials.GetDefaultCredentials().DefaultAccountId == m_ConsumerSecret, "Credentials AccountId is incorrect.");
      }
      #endregion
      ...
      {
         var marketIsHalted = m_Results.Items.FirstOrDefault(x => x.Key == "00.0").Value as ETrade10TestResult;
      ...
      {
         // 08
         var accountRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "08.0").Value as ETrade10TestResult;
         var idIsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "08.1").Value as ETrade10TestResult;
         var correctCurrency = m_Results.Items.FirstOrDefault(x => x.Key == "08.2").Value as ETrade10TestResult;
         var correctOpenTradeCount = m_Results.Items.FirstOrDefault(x => x.Key == "08.3").Value as ETrade10TestResult;
         var tradesMatchTradeCount = m_Results.Items.FirstOrDefault(x => x.Key == "08.4").Value as ETrade10TestResult;
      ...
      {
         // 03
         var instrumentReceived = m_Results.Items.FirstOrDefault(x => x.Key == "03.0").Value as ETrade10TestResult;
         var instrumentTypeCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "03.1").Value as ETrade10TestResult;
         var instrumentNameCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "03.2").Value as ETrade10TestResult;
      ...
      {
         // 04
         var summaryRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "04.0").Value as ETrade10TestResult;
         var accountIdIsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "04.1").Value as ETrade10TestResult;
         var currencyIsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "04.2").Value as ETrade10TestResult;
      ...
      {
         // 05
         var configRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "05.0").Value as ETrade10TestResult;
         var aliasChanged = m_Results.Items.FirstOrDefault(x => x.Key == "05.1").Value as ETrade10TestResult;
         var marginRateChanged = m_Results.Items.FirstOrDefault(x => x.Key == "05.2").Value as ETrade10TestResult;
         var aliasReverted = m_Results.Items.FirstOrDefault(x => x.Key == "05.3").Value as ETrade10TestResult;
         var marginRateReverted = m_Results.Items.FirstOrDefault(x => x.Key == "05.4").Value as ETrade10TestResult;
      ...
      {
         var changesRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "17.0").Value as ETrade10TestResult;
         var ordersFilledReceived = m_Results.Items.FirstOrDefault(x => x.Key == "17.1").Value as ETrade10TestResult;
         var ordersCancelledReceived = m_Results.Items.FirstOrDefault(x => x.Key == "17.2").Value as ETrade10TestResult;
         var tradesClosedReceived = m_Results.Items.FirstOrDefault(x => x.Key == "17.3").Value as ETrade10TestResult;
         var positionsReceived = m_Results.Items.FirstOrDefault(x => x.Key == "17.4").Value as ETrade10TestResult;
         var accountHasMargin = m_Results.Items.FirstOrDefault(x => x.Key == "17.5").Value as ETrade10TestResult;
      ...
      {
         var candlesRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "12.0").Value as ETrade10TestResult;
         var candlesCountCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "12.1").Value as ETrade10TestResult;
      ...
      {
         var candlesInstrumentCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "12.2").Value as ETrade10TestResult;
         var candlesGranularityCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "12.3").Value as ETrade10TestResult;
         var candlesHaveMidPrice = m_Results.Items.FirstOrDefault(x => x.Key == "12.4").Value as ETrade10TestResult;
         var candlesHaveBidPrice = m_Results.Items.FirstOrDefault(x => x.Key == "12.5").Value as ETrade10TestResult;
         var candlesHaveAskPrice = m_Results.Items.FirstOrDefault(x => x.Key == "12.6").Value as ETrade10TestResult;
      ...
      {
         var orderCreated = m_Results.Items.FirstOrDefault(x => x.Key == "11.0").Value as ETrade10TestResult;
         var orderTypeIsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "11.1").Value as ETrade10TestResult;
      ...
      {
         var allOrdersRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "11.2").Value as ETrade10TestResult;
         var testOrderTypeReturned = m_Results.Items.FirstOrDefault(x => x.Key == "11.3").Value as ETrade10TestResult;
         var allOrdersByIDRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "11.29").Value as ETrade10TestResult;
      ...
      {
         var pendingOrdersRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "11.4").Value as ETrade10TestResult;
         var onlyPendingOrderRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "11.5").Value as ETrade10TestResult;
         var testPendingOrderRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "11.6").Value as ETrade10TestResult;
      ...
      {
         var orderDetailsRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "11.7").Value as ETrade10TestResult;
         var clientExtensionsRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "11.8").Value as ETrade10TestResult;
         var tradeExtensionsRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "11.9").Value as ETrade10TestResult;
      ...
      {
         var extensionsUpdated = m_Results.Items.FirstOrDefault(x => x.Key == "11.10").Value as ETrade10TestResult;
         var extensionsOrderCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "11.11").Value as ETrade10TestResult;
         var clientExtensionCommentCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "11.12").Value as ETrade10TestResult;
         var tradeExtensionCommentCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "11.13").Value as ETrade10TestResult;
      ...
      {
         var orderWasCancelled = m_Results.Items.FirstOrDefault(x => x.Key == "11.14").Value as ETrade10TestResult;
         var orderWasReplaced = m_Results.Items.FirstOrDefault(x => x.Key == "11.15").Value as ETrade10TestResult;
         var newOrderDetailsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "11.16").Value as ETrade10TestResult;
      ...
      {
         var cancelledOrderReturned = m_Results.Items.FirstOrDefault(x => x.Key == "11.17").Value as ETrade10TestResult;
         var orderWasCancelled = m_Results.Items.FirstOrDefault(x => x.Key == "11.18").Value as ETrade10TestResult;
      ...
      {
         var orderWasCreated = m_Results.Items.FirstOrDefault(x => x.Key == "11.19").Value as ETrade10TestResult;
         var orderTypeIsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "11.20").Value as ETrade10TestResult;
         var orderHasStopLoss = m_Results.Items.FirstOrDefault(x => x.Key == "11.21").Value as ETrade10TestResult;
         var orderHasTakeProfit = m_Results.Items.FirstOrDefault(x => x.Key == "11.22").Value as ETrade10TestResult;
         var orderWasCancelled = m_Results.Items.FirstOrDefault(x => x.Key == "11.23").Value as ETrade10TestResult;
         var cancelledOrderHasCorrectReason = m_Results.Items.FirstOrDefault(x => x.Key == "11.24").Value as ETrade10TestResult;
         var newOrderWasCreated = m_Results.Items.FirstOrDefault(x => x.Key == "11.25").Value as ETrade10TestResult;
         var newOrderReasonIsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "11.26").Value as ETrade10TestResult;
         var newOrderStopLossIsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "11.27").Value as ETrade10TestResult;
         var newOrderTakeProfitIsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "11.28").Value as ETrade10TestResult;
      ...
      {
         var marketOrderCreated = m_Results.Items.FirstOrDefault(x => x.Key == "13.0").Value as ETrade10TestResult;
         var marketOrderFilled = m_Results.Items.FirstOrDefault(x => x.Key == "13.1").Value as ETrade10TestResult;
      ...
      {
         var allTradesRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "13.2").Value as ETrade10TestResult;
         var openTradesRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "13.3").Value as ETrade10TestResult;
      ...
      {
         var detailsRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "13.4").Value as ETrade10TestResult;
      ...
      {
         var extensionsUpdated = m_Results.Items.FirstOrDefault(x => x.Key == "13.5").Value as ETrade10TestResult;
         var extensionsTradeCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "13.6").Value as ETrade10TestResult;
         var tradeExtensionCommentCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "13.7").Value as ETrade10TestResult;
      ...
      {
         var takeProfitPatched = m_Results.Items.FirstOrDefault(x => x.Key == "13.8").Value as ETrade10TestResult;
         var takeProfitPriceCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "13.9").Value as ETrade10TestResult;
         var stopLossPatched = m_Results.Items.FirstOrDefault(x => x.Key == "13.10").Value as ETrade10TestResult;
         var stopLossPriceCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "13.11").Value as ETrade10TestResult;
         var trailingStopLossPatched = m_Results.Items.FirstOrDefault(x => x.Key == "13.12").Value as ETrade10TestResult;
         var trailingStopLossDistanceCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "13.13").Value as ETrade10TestResult;

         var takeProfitCancelled = m_Results.Items.FirstOrDefault(x => x.Key == "13.14").Value as ETrade10TestResult;
         var stopLossCancelled = m_Results.Items.FirstOrDefault(x => x.Key == "13.15").Value as ETrade10TestResult;
         var trailingStopLossCancelled = m_Results.Items.FirstOrDefault(x => x.Key == "13.16").Value as ETrade10TestResult;
      ...
      {
         var tradeClosed = m_Results.Items.FirstOrDefault(x => x.Key == "13.17").Value as ETrade10TestResult;
         var tradeCloseHasTime = m_Results.Items.FirstOrDefault(x => x.Key == "13.18").Value as ETrade10TestResult;
         var tradeCloseHasInstrument = m_Results.Items.FirstOrDefault(x => x.Key == "13.19").Value as ETrade10TestResult;
         var tradeCloseUnitsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "13.20").Value as ETrade10TestResult;
         var tradeCloseHasPrice = m_Results.Items.FirstOrDefault(x => x.Key == "13.21").Value as ETrade10TestResult;
      ...
      public void test_Position_get_positions()
      {
         ...
         var allPositionsRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "14.2").Value as ETrade10TestResult;
         var openPositionsRetrieved = m_Results.Items.FirstOrDefault(x => x.Key == "14.3").Value as ETrade10TestResult;
      ...
      {
         var postionHasDirection = m_Results.Items.FirstOrDefault(x => x.Key == "14.4").Value as ETrade10TestResult;
         var positionHasUnits = m_Results.Items.FirstOrDefault(x => x.Key == "14.5").Value as ETrade10TestResult;
         var positionHasAvgPrice = m_Results.Items.FirstOrDefault(x => x.Key == "14.6").Value as ETrade10TestResult;
         var positionHasInstrument = m_Results.Items.FirstOrDefault(x => x.Key == "14.7").Value as ETrade10TestResult;
      ...
      {
         var postionHasDirection = m_Results.Items.FirstOrDefault(x => x.Key == "14.8").Value as ETrade10TestResult;
         var positionHasUnits = m_Results.Items.FirstOrDefault(x => x.Key == "14.9").Value as ETrade10TestResult;
         var positionHasAvgPrice = m_Results.Items.FirstOrDefault(x => x.Key == "14.10").Value as ETrade10TestResult;
         var positionHasInstrument = m_Results.Items.FirstOrDefault(x => x.Key == "14.11").Value as ETrade10TestResult;
      ...
      {
         var closeOrderCreated = m_Results.Items.FirstOrDefault(x => x.Key == "14.12").Value as ETrade10TestResult;
         var closeOrderFilled = m_Results.Items.FirstOrDefault(x => x.Key == "14.13").Value as ETrade10TestResult;
         var closeUnitsCorrect = m_Results.Items.FirstOrDefault(x => x.Key == "14.14").Value as ETrade10TestResult;
      ...
      {
         var pricesReceived = m_Results.Items.FirstOrDefault(x => x.Key == "06.0").Value as ETrade10TestResult;
         var priceCountMatches = m_Results.Items.FirstOrDefault(x => x.Key == "06.1").Value as ETrade10TestResult;
      ...
      {
         // 7
         var streamFunctional = m_Results.Items.FirstOrDefault(x => x.Key == "07.0").Value as ETrade10TestResult;
         var dataReceived = m_Results.Items.FirstOrDefault(x => x.Key == "07.1").Value as ETrade10TestResult;
         var dataHasId = m_Results.Items.FirstOrDefault(x => x.Key == "07.2").Value as ETrade10TestResult;
         var dataHasAccountId = m_Results.Items.FirstOrDefault(x => x.Key == "07.3").Value as ETrade10TestResult;
      ...
      {
         // 18
         var streamFunctional = m_Results.Items.FirstOrDefault(x => x.Key == "18.0").Value as ETrade10TestResult;
         var dataReceived = m_Results.Items.FirstOrDefault(x => x.Key == "18.1").Value as ETrade10TestResult;
         var dataHasInstrument = m_Results.Items.FirstOrDefault(x => x.Key == "18.2").Value as ETrade10TestResult;
         ...
         try
         {
            var dataHasBids = m_Results.Items.FirstOrDefault(x => x.Key == "18.3").Value as ETrade10TestResult;
            var dataHasAsks = m_Results.Items.FirstOrDefault(x => x.Key == "18.4").Value as ETrade10TestResult;
      ...
      {
         var caughtAccountConfigurationError = m_Results.Items.FirstOrDefault(x => x.Key == "05.E0").Value as ETrade10TestResult;
         var caughtOrderPostError = m_Results.Items.FirstOrDefault(x => x.Key == "11.E0").Value as ETrade10TestResult;
         var caughtOrderClientExtensionsModifyError = m_Results.Items.FirstOrDefault(x => x.Key == "11.E1").Value as ETrade10TestResult;
         var caughtOrderCancelReplaceError = m_Results.Items.FirstOrDefault(x => x.Key == "11.E2").Value as ETrade10TestResult;
         var caughtOrderCancelError = m_Results.Items.FirstOrDefault(x => x.Key == "11.E3").Value as ETrade10TestResult;
         var caughtTradeClientExtensionsModifyError = m_Results.Items.FirstOrDefault(x => x.Key == "13.E0").Value as ETrade10TestResult;
         var caughtTradePatchExitOrdersError = m_Results.Items.FirstOrDefault(x => x.Key == "13.E1").Value as ETrade10TestResult;
         var caughtTradeCloseError = m_Results.Items.FirstOrDefault(x => x.Key == "13.E2").Value as ETrade10TestResult;
         var caughtPositionCloseError = m_Results.Items.FirstOrDefault(x => x.Key == "14.E0").Value as ETrade10TestResult;
