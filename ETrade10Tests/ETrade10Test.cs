...
namespace OkonkwoETrade10Tests
{
   ...
   public partial class ETrade10Test : ETrade10TestBase
   {
      ...
      {
         Assert.IsTrue(m_ETrade10.Credentials.environment == m_Environment, "Credentials Environment is incorrect.");
         Assert.IsTrue(m_ETrade10.Credentials.consumerKey?.Length > 0, "Credentials ConsumerKey missing.");
         Assert.IsTrue(m_ETrade10.Credentials.consumerSecret?.Length > 0, "Credentials ConsumerSecret missing.");
      }
      #endregion

      #region Market
      [TestMethod]
      public void test_Market_market_is_halted()
      {
